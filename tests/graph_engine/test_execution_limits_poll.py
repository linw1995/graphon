...
def test_dispatcher_poll_abort_command_cancels_and_aborts_execution() -> None:
    ...
    command_processor.register_handler(AbortCommand, AbortCommandHandler(token))
    ...
    assert token.reason.startswith("Maximum execution time exceeded:")
